...
public class Version {
	...
	// -- Will be replaced on build with ANT
	public static  final String	VERSION 			= "@VERSION@";
	public static  final String BUILD_NUMBER 		= "@BUILD_NUMBER@";
	private static final String REMOTE_VERSION_FILE = "http://zerzera.demo.keezze.nl/version.txt";
	...
	public static void versionCheck() {
		try {
			...
			String line = null;
			String mcVersion = CommonProxy.proxy.getMinecraftVersion();
